        ...
        buttonLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (editTextLoginToString.equals(login) && editTextPasswordToString.equals(password)) {
                    Toast.makeText(MainActivity.this, "Логин-пароль верный!\n" + login + " " + password, Toast.LENGTH_LONG).show();
                } else {
            ...
            public void onClick(View v) {
                ...
                if (checkBox.isChecked()) {
                    ...
                    try {
                        ...
                        Log.i("BufferedReader", "ЗАПИСАНЫ ВО внутренний ФАЙЛ логин:" + login + " и пароль:" + password);
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                }
